	...
	void product(){
		...
		while (true) {
			...
			case 3: 
				...
				if(dao.addProduct(cb2)) {
					System.out.println("GOOD DAY, UPDATED");
				}else System.err.println("somthing went wrong buddy, try again..!");
				break;
