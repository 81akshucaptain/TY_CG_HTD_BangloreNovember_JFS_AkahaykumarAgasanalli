...
import com.capgemini.forestmnagement.exception.HaulierAddException;
import com.capgemini.forestmnagement.exception.InputMissMatchForIntegerException;
import com.capgemini.forestmnagement.factory.ForestFactoryFmDb;

public class ContractorApplication {
	void contractor(int cid) {
		ContractorDAO contractDao=ForestFactoryFmDb.createInstanceOfContractorDAOImpl();
